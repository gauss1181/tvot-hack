...
@interface GN_ACR_SDKViewController : UIViewController <IGnAcrResultDelegate, IGnAcrStatusDelegate, AVAudioSessionDelegate, GnAudioSourceDelegate, GnFPCacheSourceDelegate, SettingsDelegate>
{
